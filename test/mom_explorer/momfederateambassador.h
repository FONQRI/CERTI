...
public:
    ...
    // 4.8
    virtual void
    reportFederationExecutions(FederationExecutionInformationVector const& theFederationExecutionInformationList) override;

    // 4.12
    virtual void
    synchronizationPointRegistrationSucceeded(std::wstring const& label) override;

    virtual void synchronizationPointRegistrationFailed(
        std::wstring const& label, SynchronizationPointFailureReason reason) override;
    ...
    virtual void federationNotSaved(SaveFailureReason theSaveFailureReason) override;

    // 4.23
    virtual void federationSaveStatusResponse(FederateHandleSaveStatusPairVector const& theFederateStatusVector) override;
    ...
    virtual void
    federationNotRestored(RestoreFailureReason theRestoreFailureReason) override;

    // 4.32
    virtual void federationRestoreStatusResponse(
        FederateRestoreStatusVector const& theFederateRestoreStatusVector) override;
    ...
    // 5.10
    virtual void startRegistrationForObjectClass(ObjectClassHandle theClass) override;

    // 5.11
    virtual void stopRegistrationForObjectClass(ObjectClassHandle theClass) override;

    // 5.12
    virtual void turnInteractionsOn(InteractionClassHandle theHandle) override;

    // 5.13
    virtual void turnInteractionsOff(InteractionClassHandle theHandle) override;
    ...
    virtual void confirmAttributeOwnershipAcquisitionCancellation(
        ObjectInstanceHandle theObject, AttributeHandleSet const& theAttributes) override;
    ...
    // 8.22
    virtual void requestRetraction(MessageRetractionHandle theHandle) override;
